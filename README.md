...
It features DOM-agnostic XPath 2.0 engine [xpath2.js](https://github.com/ilinsky/xpath2.js) with strong XML Schema 1.1 data typing.
...
$(document).xpath("my:body", resolver);	// Returns element body ('my' prefix resolved to XHTML ns)
```
